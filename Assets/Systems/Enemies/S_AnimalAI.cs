...
public class S_AnimalAI : MonoBehaviour
{
    ...
    Transform enemy;
    [SerializeField] float runRange = 20; //How far the Deer have to run to resume the usual activities
    float multiplier = 1;
    ...
    void Update()
    {
        animator.SetBool("Eating", currentState == AIState.Eating);
        animator.SetBool("Walking", currentState == AIState.Walking);
        animator.SetBool("Running", currentState == AIState.Running);
